...
Graft CLI commands expose JSON output so applications do not have to scrape
terminal text. Use JSON for status badges, change review screens, merge
conflict flows, sync progress, and payload cache views.
