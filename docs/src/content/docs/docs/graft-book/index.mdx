...
description: Follow one application change through Graft's repository, SQLite storage, merge, remote, and recovery layers.
---

This guide answers one question: **after an application commits a SQLite transaction, how does
...
Read this section after completing a CLI or SDK quickstart. It explains the
system boundaries needed to design a safe integration; task pages remain the
source for command sequences, and the specifications define exact contracts.
