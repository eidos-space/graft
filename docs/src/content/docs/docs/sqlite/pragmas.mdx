...
Returns commit history as a JSON array. Each entry includes `lsn`, `page_count`, `segment`, `is_checkpoint`, `changed_pages`, and `timestamp_ms` (unix milliseconds).
...
```json
[
  {"lsn":3,"page_count":2,"segment":"2vt5fF...","is_checkpoint":false,"changed_pages":1,"timestamp_ms":1717482202003},
  {"lsn":2,"page_count":2,"segment":"3GMtDE...","is_checkpoint":false,"changed_pages":1,"timestamp_ms":1717482202002}
]
```
