...
Returns commit history as a JSON array. Each entry includes `lsn`, `page_count`, `segment`, `is_checkpoint`, and `changed_pages`.
...
[
  ...
  {"lsn":1,"page_count":2,"segment":"3Tn3QB...","is_checkpoint":true,"changed_pages":2}
]
```
